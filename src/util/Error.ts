 ...
 *   It also works with inheritance. But sometimes we have an error object coming from
 *   a 3rd-party library and there’s no easy way to get its class. Then name property can be used for such checks.
 *
 * - Wrapping exceptions is a widespread technique:
 *   a function handles low-level exceptions and creates higher-level errors instead of various low-level ones.
